...
<b>Ник:</b> ваш игровой ник
<b>Ранг:</b> на какой ранг претендуете  
<b>Доказательства:</b> описание прикрепленных доказательств
...
COMMAND_DESCRIPTIONS = {
    ...
    "setfamilychat": "Установить чат семьи (только создатель)",
    "idea": "Отправить идею руководству семьи"
}
